...
names(UAE_demoDat)[c(9, 15:16, 19:30, 32, 34, 35)] <- c('P_Sex', 'P_Height', 'P_Weight', 'P_WeightStatus',
                                                        'Fam_OB_YN', 'Fam_OB_list', 'Fam_ED_YN', 'Fam_ED_list',
                                                        'Child_CronicIll_YN', 'Child_CronicIll_list',
                                                        'P_childHeight', 'P_childWeight', 'Child_Hist_OW', 
                                                        'Child_Hist_ED', 'TV_hrday', 'VG_Comp_hrday', 'Media_hrday', 'Month_AED')
...
UAE_allDat$Anemia <- ifelse(is.na(UAE_allDat$Anemia), NA,
                            ifelse(UAE_allDat$Anemia == 'IronDeficiency', 'Iron Deficiency Anemia (ID)',
                                   ifelse(UAE_allDat$Anemia == 'ThalassemiaMinor', 'Thalassemia Minor (TM)',
                                          ifelse(UAE_allDat$Anemia == 'IronDeficiency, ThalassemiaMinor', 'ID + TM',
                                                 ifelse(UAE_allDat$Anemia == 'IronDeficiency -G6PD', 'ID + G6PD Deficiency',
                                                        ifelse(UAE_allDat$Anemia == 'G6PD', 'G6PD Deficiency', 'Unspecified Anemia'))))))
UAE_allDat$Anemia <- factor(UAE_allDat$Anemia, 
                            levels = c('Iron Deficiency Anemia (ID)', 'Thalassemia Minor (TM)',
                                       'G6PD Deficiency', 'ID + TM', 'ID + G6PD Deficiency', 'Unspecified Anemia'))

UAE_allDat$Hyperlipidemia <- ifelse(is.na(UAE_allDat$Hyperlipidemia), NA,
                                    ifelse(UAE_allDat$Hyperlipidemia == 'mixed Hyperlipidemia', 'Hyperlipidemia - Mixed',
                                           ifelse(UAE_allDat$Hyperlipidemia == 'Hyperlipidemia', 'Hyperlipidemia', 'Error')))
UAE_allDat$Hyperlipidemia <- factor(UAE_allDat$Hyperlipidemia, 
                                    levels = c('Hyperlipidemia', 'Hyperlipidemia - Mixed'))

UAE_allDat$ThyroidConditions <- ifelse(is.na(UAE_allDat$ThyroidConditions), NA,
                                       ifelse(UAE_allDat$ThyroidConditions == 'AbnormalThyroidTunctions_notx', 'Abnormal Function',
                                              ifelse(UAE_allDat$ThyroidConditions == 'AutoimmuneThyroiditis', 'Autoimmune Thyroiditis', 
                                                     ifelse(UAE_allDat$ThyroidConditions == 'goiter', 'Goiter', 
                                                            ifelse(UAE_allDat$ThyroidConditions == 'Hypothyroidism-autoimmune', 'Autoimmune Thyroiditis',
                                                                   ifelse(UAE_allDat$ThyroidConditions == 'Hypothyroidism-unspecified', 'Unspecified Hypothyroidism','Error'))))))
UAE_allDat$ThyroidConditions <- factor(UAE_allDat$ThyroidConditions, 
                                       levels = c('Abnormal Function', 'Autoimmune Thyroiditis',
                                                  'Autoimmune Hypothyroidism', 'Unspecified Hypothyroidism',
                                                  'Goiter'))

UAE_allDat$GlycemicStatus <- ifelse(is.na(UAE_allDat$GlycemicStatus), NA,
                                    ifelse(UAE_allDat$GlycemicStatus == 'ImpairedFastingGlucose', 'Impaired Fasting Glucose',
                                           ifelse(UAE_allDat$GlycemicStatus == 'ImpairedGlucoseToleranceTest', 'Impaired Glucose Tolerance Test', 
                                                  ifelse(UAE_allDat$GlycemicStatus == 'Type1Diabetes', 'Type-1 Diabetes', 'Error'))))
UAE_allDat$GlycemicStatus <- factor(UAE_allDat$GlycemicStatus, 
                                    levels = c('Impaired Fasting Glucose', 'Impaired Glucose Tolerance Test',
                                               'Type-1 Diabetes'))


UAE_allDat$Hypertension <- ifelse(is.na(UAE_allDat$Hypertension), NA,
                                  ifelse(UAE_allDat$Hypertension == 'EssentialPrimaryHypertension', 'Essential Primary Hypertension',
                                         ifelse(UAE_allDat$Hypertension == 'HighBloodPressure', 'High Blood Pressure', 'Error')))
UAE_allDat$Hypertension <- factor(UAE_allDat$Hypertension, 
                                  levels = c('Essential Primary Hypertension', 'High Blood Pressure'))

UAE_allDat$MetabolicSyndrome <- ifelse(is.na(UAE_allDat$MetabolicSyndrome), NA,
                                       ifelse(UAE_allDat$MetabolicSyndrome == 'Y', 'Metabolic Syndrome', 'Error'))
UAE_allDat$MetabolicSyndrome <- factor(UAE_allDat$MetabolicSyndrome, 
                                       levels = c('Metabolic Syndrome'))

UAE_allDat$AcanthosisNigricans <- ifelse(is.na(UAE_allDat$AcanthosisNigricans), NA,
                                         ifelse(UAE_allDat$AcanthosisNigricans == 'AcanthosisNigricans', 'Acanthosis Nigricans', 'Error'))
UAE_allDat$AcanthosisNigricans <- factor(UAE_allDat$AcanthosisNigricans, 
                                         levels = c('Acanthosis Nigricans'))

UAE_allDat$Growth.Stature <- ifelse(is.na(UAE_allDat$Growth.Stature), NA,
                                    ifelse(UAE_allDat$Growth.Stature == 'FailureToThrive', 'Failure To Thrive (FT)',
                                           ifelse(UAE_allDat$Growth.Stature == 'GrowthHormoneDeficency', 'Growth Hormone Deficency', 
                                                  ifelse(UAE_allDat$Growth.Stature == 'ShortStature', 'Short Stature', 
                                                         ifelse(UAE_allDat$Growth.Stature == 'ShortStature, FailureToThrive, Underweight', 'FT + ShortStature + Underweight', 
                                                                ifelse(UAE_allDat$Growth.Stature == 'ShortStature, PrecociousPuberty', 'Short Stature + Precocious Puberty', 'Error'))))))
UAE_allDat$Growth.Stature <- factor(UAE_allDat$Growth.Stature, 
                                    levels = c('Failure To Thrive (FT)', 'Growth Hormone Deficency',
                                               'Short Stature', 'FT + ShortStature + Underweight', 'Short Stature + Precocious Puberty'))

UAE_allDat$PCOS <- ifelse(is.na(UAE_allDat$PCOS), NA,
                          ifelse(UAE_allDat$PCOS == 'PCOS', 'PCOS',
                                 ifelse(UAE_allDat$PCOS == 'Hirsutism', 'Hirsutism', 
                                        ifelse(UAE_allDat$PCOS == 'hirsutism, unspecified ovarian cysts', 'Hirsutism + Unspecified Ovarian Cysts', 'Error'))))
UAE_allDat$PCOS <- factor(UAE_allDat$PCOS, 
                          levels = c('PCOS', 'Hirsutism',
                                     'Hirsutism + Unspecified Ovarian Cysts'))
...
UAE_allDat$Relationship <- factor(UAE_allDat$Relationship,
                                  levels = c('Mother', 'Father', 'Uncle'))
...
UAE_allDat$nFam_Obesity = rowSums(UAE_allDat[c('Mother_OBhistory', 'Father_OBhistory',
                                    ...
                                    !is.na(UAE_allDat[c('Mother_OBhistory', 'Father_OBhistory',
                                                        'Grandmother_OBhistory', 'Grandfather_OBhistory',
                                                        'Sister_OBhistory', 'Brother_OBhistory',
                                                        'Aunt_OBhistory', 'Uncle_OBhistory')]))
...
UAE_allDat$nFam_EatingDisorder = rowSums(UAE_allDat[c('Mother_EDhistory', 'Father_EDhistory',
                                           ...
                                           !is.na(UAE_allDat[c('Mother_EDhistory', 'Father_EDhistory',
                                                               'Grandmother_EDhistory', 'Grandfather_EDhistory',
                                                               'Sister_EDhistory', 'Brother_EDhistory',
                                                               'Aunt_EDhistory', 'Uncle_EDhistory')]))



#parent reported weight status
UAE_allDat$P_WeightStatus <- ifelse(UAE_allDat$P_WeightStatus == 'Overweight' | UAE_allDat$P_WeightStatus == 'Overweight ' | 
                                      UAE_allDat$P_WeightStatus == 'Overeweight', 'Overweight', as.character(UAE_allDat$P_WeightStatus))
UAE_allDat$P_WeightStatus <- factor(UAE_allDat$P_WeightStatus, 
                                                      ...
                                                      ifelse(UAE_allDat$VG_Comp_hrday == '1', '1+',
                                                             ifelse(UAE_allDat$VG_Comp_hrday == '2', '2+',
                                                                    ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '3', 
                                                                           ifelse(UAE_allDat$VG_Comp_hrday == '3', '3+',
                                                                                  ifelse(UAE_allDat$VG_Comp_hrday == '4', '4+', '5+'))))))), 
                                        ifelse(UAE_allDat$TV_hrday == '1', 
                                               ifelse(is.na(UAE_allDat$VG_Comp_hrday) | UAE_allDat$VG_Comp_hrday == 'none', '1',
                                                      ifelse(UAE_allDat$VG_Comp_hrday == '<1', '1+', 
                                                             ifelse(UAE_allDat$VG_Comp_hrday == '1', '2',
                                                                    ifelse(UAE_allDat$VG_Comp_hrday == '2', '3',
                                                                           ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '3.5', 
                                                                                  ifelse(UAE_allDat$VG_Comp_hrday == '3', '4',
                                                                                         ifelse(UAE_allDat$VG_Comp_hrday == '4', '5', '6+'))))))),
                                               ifelse(UAE_allDat$TV_hrday == '2', 
                                                      ifelse(is.na(UAE_allDat$VG_Comp_hrday) | UAE_allDat$VG_Comp_hrday == 'none', '2',
                                                             ifelse(UAE_allDat$VG_Comp_hrday == '<1', '2+', 
                                                                    ifelse(UAE_allDat$VG_Comp_hrday == '1', '3',
                                                                           ifelse(UAE_allDat$VG_Comp_hrday == '2', '4',
                                                                                  ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '4.5', 
                                                                                         ifelse(UAE_allDat$VG_Comp_hrday == '3', '5',
                                                                                                ifelse(UAE_allDat$VG_Comp_hrday == '4', '6', '7+'))))))),
                                                      ifelse(UAE_allDat$TV_hrday == '2.5', 
                                                             ifelse(is.na(UAE_allDat$VG_Comp_hrday) | UAE_allDat$VG_Comp_hrday == 'none', '2.5',
                                                                    ifelse(UAE_allDat$VG_Comp_hrday == '<1', '3', 
                                                                           ifelse(UAE_allDat$VG_Comp_hrday == '1', '3.5',
                                                                                  ifelse(UAE_allDat$VG_Comp_hrday == '2', '4.5',
                                                                                         ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '5', 
                                                                                                ifelse(UAE_allDat$VG_Comp_hrday == '3', '5.5',
                                                                                                       ifelse(UAE_allDat$VG_Comp_hrday == '4', '6.5', '7+'))))))),
                                                             ifelse(UAE_allDat$TV_hrday == '3', 
                                                                    ifelse(is.na(UAE_allDat$VG_Comp_hrday) | UAE_allDat$VG_Comp_hrday == 'none', '3',
                                                                           ifelse(UAE_allDat$VG_Comp_hrday == '<1', '3.5', 
                                                                                  ifelse(UAE_allDat$VG_Comp_hrday == '1', '4',
                                                                                         ifelse(UAE_allDat$VG_Comp_hrday == '2', '5',
                                                                                                ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '5.5', 
                                                                                                       ifelse(UAE_allDat$VG_Comp_hrday == '3', '6',
                                                                                                              ifelse(UAE_allDat$VG_Comp_hrday == '4', '7', '8+'))))))),
                                                                    ifelse(UAE_allDat$TV_hrday == '4', 
                                                                           ifelse(is.na(UAE_allDat$VG_Comp_hrday) | UAE_allDat$VG_Comp_hrday == 'none', '4',
                                                                                  ifelse(UAE_allDat$VG_Comp_hrday == '<1', '4.5', 
                                                                                         ifelse(UAE_allDat$VG_Comp_hrday == '1', '5',
                                                                                                ifelse(UAE_allDat$VG_Comp_hrday == '2', '6',
                                                                                                       ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '6.5', 
                                                                                                              ifelse(UAE_allDat$VG_Comp_hrday == '3', '7',
                                                                                                                     ifelse(UAE_allDat$VG_Comp_hrday == '4', '8', '9+'))))))),
                                                                           ifelse(UAE_allDat$TV_hrday == '5+', 
                                                                                  ifelse(is.na(UAE_allDat$VG_Comp_hrday) | UAE_allDat$VG_Comp_hrday == 'none', '5+',
                                                                                         ifelse(UAE_allDat$VG_Comp_hrday == '<1', '5+', 
                                                                                                ifelse(UAE_allDat$VG_Comp_hrday == '1', '6+',
                                                                                                       ifelse(UAE_allDat$VG_Comp_hrday == '2', '7+',
                                                                                                              ifelse(UAE_allDat$VG_Comp_hrday == '2.5', '7+', 
                                                                                                                     ifelse(UAE_allDat$VG_Comp_hrday == '3', '8+',
                                                                                                                            ifelse(UAE_allDat$VG_Comp_hrday == '4', '9+', '10+'))))))),
                                                                                  ifelse(is.na(UAE_allDat$TV_hrday) | UAE_allDat$TV_hrday == 'none', as.character(UAE_allDat$VG_Comp_hrday), 'error')))))))))

#adjust for parent notes
UAE_allDat$Media_hrday <- ifelse(is.na(UAE_allDat$HoursDay_TVnotes), as.character(UAE_allDat$Media_hrday),
                                 ifelse(UAE_allDat$HoursDay_TVnotes == '\"ipad all the time\"' | UAE_allDat$HoursDay_TVnotes == '\"on phone all day\"' |
                                                             ...
                                                             ifelse(UAE_allDat$Media_hrday == '1', '3',
                                                                    ifelse(UAE_allDat$Media_hrday == '1+', '3+',
                                                                           ifelse(UAE_allDat$Media_hrday == '2', '4',
                                                                                  ifelse(UAE_allDat$Media_hrday == '2.5', '4.5',
                                                                                         ifelse(UAE_allDat$Media_hrday == '2+', '4+', 
                                                                                                ifelse(UAE_allDat$Media_hrday == '3', '5',
                                                                                                       ifelse(UAE_allDat$Media_hrday == '3.5', '5.5',
                                                                                                              ifelse(UAE_allDat$Media_hrday == '3+', '5+',
                                                                                                                     ifelse(UAE_allDat$Media_hrday == '4', '6',
                                                                                                                            ifelse(UAE_allDat$Media_hrday == '4.5', '6.5',
                                                                                                                                   ifelse(UAE_allDat$Media_hrday == '4+', '6+',
                                                                                                                                          ifelse(UAE_allDat$Media_hrday == '5', '7',
                                                                                                                                                 ifelse(UAE_allDat$Media_hrday == '5.5', '7.5',
                                                                                                                                                        ifelse(UAE_allDat$Media_hrday == '5+', '7+',
                                                                                                                                                               ifelse(UAE_allDat$Media_hrday == '6+', '8+',
                                                                                                                                                                      ifelse(UAE_allDat$Media_hrday == '7+', '9+', '10+')))))))))))))))))), 
