...
```{r IOTF_pOWcutoff_DensityPlot, echo=FALSE, figure = TRUE, include = FALSE}
IOTF_pOWcutoff_plot
```
...
kable(IOTF_pOWcutoff_nFamOB_tab, digits = 3, caption = "Linear Model: Peer Problems (raw) - SES category + Maternal Education + Age + Sex + pOWcutoff", booktabs=TRUE)  %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
