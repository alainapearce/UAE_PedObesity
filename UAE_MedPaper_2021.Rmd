...
### Correlation with Number of Comorbidities
...
### Correlations with Number of Relative Categories with History


```{r IOTF_pOWcutoff_nFam_cor, echo=FALSE, results='asis'}
kable(IOTF_pOWcutoff_FamHistory_cormat, digits = 3, caption = "Correlations between number of relative categories with history and percent of overweight", booktabs=TRUE)  %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```

\FloatBarrier

Percent of overweight cutoff was not associated with reported number of relative categories with an perceived to have had an eating disorder but was associated with family history of obesity.
